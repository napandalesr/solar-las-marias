  ...
  return (
      <>
        ...
        <main className="w-screen">
          ...
          <section id="projects" className="md:h-screen text-center relative bg-white">
            ...
            <section
                className="flex md:flex-col lg:flex-row items-start justify-center gap-6 xl:gap-16 pt-8 md:pt-40 md:px-8 lg:px-0 2xl:pt-32">
              <section
                  className={`flex flex-col items-start justify-start text-primary md:ml-8 px-6 md:px-0 ${screenWith > 760 ? navBar === 'projects' ? ' animate__fadeInLeft' : ' animate__fadeOutLeft' : ''}`}>
                <h4 className="font-black text-2xl xl:text-3xl uppercase">A qué le Apostamos</h4>
                <span
                    className={`md:-ml-80 xl:-ml-72 bg-yelow h-1 rounded-xl w-2/3 md:w-[42rem] ${screenWith > 760 ? navBar === 'projects' ? ' animate__fadeInLeft' : ' animate__fadeOutLeft' : ''}`}/>
              ...
              <div className={"hidden md:flex items-start justify-center gap-6 xl:gap-16"}>
                ...
                <section
                    className={`hidden md:block ${screenWith > 760 ? navBar === 'projects' ? ' animate__fadeInRight' : ' animate__fadeOutRight' : ''}`}>
                  {
                    project === 0 ? (
                        <div
      ...
      <span
        ...
        <section ref={elementRef}
          ...
          <span
              className="px-4 lg:pr-8 flex justify-center flex-col lg:flex-row items-center 2xl:items-start"> <strong
              className="text-3xl md:text-4xl lg:text-3xl xl:text-4xl lg:mr-4 flex items-end text-center lg:text-start">Licencia Ambiental </strong><span
        ...
        <section
          ...
          <section id="news" className="h-screen w-screen flex relative flex-col-reverse md:flex-row bg-white">
            <section
              ...
              <div className={"flex flex-col items-start justify-start gap-8 2xl:gap-12 w-full py-32 2xl:py-44 px-16 xl:px-32"}>
                ...
                <ul className={"flex items-center justify-start gap-6"}>
                  <li className={"bg-primary font-semibold text-white px-6 py-4 rounded-xl min-w-52 xl:min-w-64 box-border"}><Link
                      className={"flex items-center justify-center gap-4"} href={"https://linkedin.com"}>Ver en
                    Linkedin <Linkedin/></Link></li>
                  <li className={"bg-primary font-semibold text-white px-6 py-4 rounded-xl min-w-52 xl:min-w-64 box-border"}><Link
                      className={"flex items-center justify-center gap-4"} href={"https://twitter.com"}>Ver en
                    X <TwitterX/></Link></li>
                </ul>
              </div>
              <div className={"w-[60%] relative select-none pointer-events-none"}>
                ...
                <span className={"absolute w-full h-full bg-gradient-to-l from-black/50 via-black/10"}/>
              </div>
            </section>
            {
                screenWith > 760 &&
          ...
          <Link className="rotate-180" href={'#capacity'} onClick={() => setNavBar('capacity')}><ArrowDownCircle
            className="text-primary animate__fadeInUpBig aspect-square h-10 2xl:h-auto"
            size={60}/> </Link>
      ...
      <span
        ...
        <span
            className="md:w-1/2 absolute bottom-56 md:bottom-auto md:left-auto md:relative left-4 flex flex-col md:flex-col">
